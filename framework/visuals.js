...
registerVisual('sankey', (host, props) => {
  ...
  // sink nodes (a target, never a source) label inward so they don't clip the right edge
  ...
  return mountECharts(host, {
    ...
    series: [{
      type: 'sankey',
      left: 8, right: 8, top: title ? 78 : 24, bottom: 24,
      nodeGap: 14, nodeWidth: 14, nodeAlign: 'justify',
...
registerVisual('tree', (host, props) => {
  ...
  return mountECharts(host, {
    ...
    series: [{
      type: 'tree',
      data: data ? [data] : [],
      top: title ? 96 : 32, bottom: 30, left: 40, right: 180,
      layout: 'orthogonal', orient, roam: false,
