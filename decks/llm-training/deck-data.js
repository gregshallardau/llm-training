window.__DECK__ = {
  ...
  "slides": [
    ...
    {
      "layout": "content",
      "heading": "Let's do a real one: a PDF report → numbers you can use",
      "blocks": [
        {
          "type": "callout",
          "title": "Every job is the same three moves",
          "body": "Get your material in → ask in plain English → check the result. Copilot works on what's already in front of it, so the first move is usually yours. Here's exactly how, click by click.\n"
        },
        {
          "type": "timeline",
          "items": [
            {
              "title": "1 · Get the PDF's numbers into Excel",
              "body": "Open Excel. On the top menu click Data, then Get Data → From File → From PDF, and choose your file."
            },
            {
              "title": "2 · Pick the table and click Load",
              "body": "Excel shows the tables it spotted in the PDF. Tick the one you want — the numbers drop straight into a spreadsheet. No retyping."
            },
            {
              "title": "3 · Ask Copilot in plain English",
              "body": "Click any cell in the data, open Copilot (top-right), and type what you want: “summarise this and show me the trend.”"
            },
            {
              "title": "4 · Check it, then use it",
              "body": "Read what it did, fix anything that looks off, and it's ready. You stayed in charge the whole way."
            }
          ]
        }
      ],
      "notes": "Teach this live if you can — share your screen and actually do it with a real file.\nThe thing people miss: getting the PDF's numbers into Excel is a normal Excel step\n(Data → Get Data → From PDF), not a Copilot trick — Copilot takes over once the data\nis in the grid. Works on Windows Excel with digital (not scanned) PDFs. Then\ngeneralise: the same three moves — get it in, ask plainly, check — work for drafting\na document in Word or summarising a thread in Outlook. Offer to walk through their\nown file next.\n"
    },
    {
      "layout": "content",
